...
RSpec.describe Nexmo::Markdown::Tutorial, type: :model do
  before do
  ...
  describe '#load' do
    it 'returns a single tutorial' do
      ...
      expect(tutorial).to be_kind_of(described_class)
      ...
      expect(tutorial.subtasks).to match_array([application_subtask, outbound_call_subtask])
    end
...
def create_application_content
  path = "#{described_class.task_content_path}/en/application/create-voice.md"
  stub_task_content(
    path: path,
    title: 'Create a voice application',
    description: 'Learn how to create a voice application',
...
def create_outbound_call_content
  path = "#{described_class.task_content_path}/en/voice/make-outbound-call.md"
  stub_task_content(
    path: path,
    title: 'Make an outbound call',
    description: 'Simple outbound call example',
